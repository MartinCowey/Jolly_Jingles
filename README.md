...
For Admin access with relevant sign-in information: [ADD ADMIN LINK)



 
<INSERT IMAGE HERE FOR SOME REASON>
...
The Lobster font was used for the advent calendar portion of the website as it had a festive theme and was bold enough and with good contrast.
  ...
  ![colour-scheme](COLOURS IMAGE)

        
The colour scheme for the events page was (?????????) this was so it was easy to navigate and read.
...
The ability to rate and review our website. With login features and comments.
